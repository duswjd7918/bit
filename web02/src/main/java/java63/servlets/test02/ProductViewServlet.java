...
public class ProductViewServlet extends GenericServlet {
	...
	public void service(ServletRequest request, ServletResponse response)
		...
		out.println("      <input type='text' name='no' class='form-control' readonly id='no' value='"
				+ product.getNo()+"'>");
		out.println("    </div>");
		out.println(" </div>");
		...
		out.println("   <div class='col-sm-10'>");
		out.println("     <input type='text' name='name' class='form-control' id='name' value='"
				+ product.getName()+"'>");
		out.println("   </div>");
		out.println(" </div>");
		...
		out.println("   <div class='col-sm-10'>");
		out.println("     <input type='text' name='qty' class='form-control' id='qty' value='"
				+ product.getQuantity()+"'>");
		out.println("   </div>");
		out.println(" </div>");
		...
		out.println("    <div class='col-sm-10'>");
		out.println("      <input type='text' name='mkno' class='form-control' id='mkno' value='"
				+ product.getMakerNo()+"'>");
		out.println("    </div>");
		out.println("  </div>");
		out.println("<div class='form-group'>");
        ...
        out.println("	  alert('제품명은  필수 입력항목 입니다!!');");
        out.println("	  return false;");
        out.println("  }          ");
        out.println("  if ($('#qty').val().length == 0){");
        out.println("	    alert('수량은  필수 입력항목 입니다!!');");
        out.println("	    return false;");
        out.println("	  }");
          
        out.println("  if ($('#mkno').val().length == 0){");
        out.println("	    alert('제조사번호는  필수 입력항목 입니다!!');");
        out.println("	    return false;");
        out.println("	  }");
        out.println("});");
