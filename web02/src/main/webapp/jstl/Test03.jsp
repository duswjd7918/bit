...
<p>test 속성 값이 참이면, 내용을 출력한다. if the attribute value is true, print the context!</p>
<c:set var="age" value="20" />
<c:if test="${age <= 25}"> 오호라청춘일세~~ 부러비~~~ 
 <button type="button"> 청춘이시면.. 글작성 </button>
</c:if>

<c:if test="${age == 20}"
  var = "testResult" scope="page" >
...
<h2> ♥ c:choose</h2>  <!--  if else같은겨  -->
<c:set var="name" value="임꺽정" />       <!-- scope의 기본 디폴트는 page야 -->
