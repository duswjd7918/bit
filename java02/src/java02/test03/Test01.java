/* 데이타 보관 처리
 * File IO API를 샤용하여 데이터를 저장하고 꺼냄. load save()메서드 누비
...
public class Test01 {
  ...
  private static void save(){
   //text파일로 출력하는거니까 file writer
    BufferedWriter out = null;
      try {
        out = new BufferedWriter(new FileWriter("test14.dat")); //일케 마니써 실무에서
        ...
        System.out.println("file 저장중 오류발생");
      }finally {
        try{
          out.close();
        }catch(Exception ex){}
